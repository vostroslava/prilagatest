...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground group-data-horizontal/tabs:h-8 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default: "border border-border/80 bg-muted/70 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]",
  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "data-active:border-border/80 data-active:bg-background data-active:text-foreground data-active:shadow-[0_10px_30px_rgba(15,23,42,0.08)] dark:data-active:shadow-[0_10px_30px_rgba(0,0,0,0.18)]",
